...
from stg.order_system_dag.pg_saver_restaurants import PgSaverRestaurants
from stg.order_system_dag.pg_saver_orders import PgSaverOrders
from stg.order_system_dag.pg_saver_users import PgSaverUsers
...
from stg.order_system_dag.object_reader import ObjectReader
...
def sprint5_stg_order_system_dag():
    ...
    def load_restaurants():
        ...
        collection_reader = ObjectReader(mongo_connect)
...
order_stg_dag = sprint5_stg_order_system_dag()  # noqa
