...
from examples.stg.order_system_dag.pg_saver_users import PgSaverUsers
...
class UserLoader:
    ...
    def __init__(self, collection_loader: ObjectReader, pg_dest: PgConnect, pg_saver: PgSaverUsers, logger: Logger) -> None:
