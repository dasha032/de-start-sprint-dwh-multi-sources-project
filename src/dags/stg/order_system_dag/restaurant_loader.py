...
from examples.stg.order_system_dag.pg_saver_restaurants import PgSaverRestaurants
from examples.stg.order_system_dag.object_reader import ObjectReader
...
class RestaurantLoader:
    ...
    def __init__(self, collection_loader: ObjectReader, pg_dest: PgConnect, pg_saver: PgSaverRestaurants, logger: Logger) -> None:
    ...
    def run_copy(self) -> int:
        ...
        with self.pg_dest.connection() as conn:
            ...
            load_queue = self.collection_loader.get_objects(last_loaded_ts, self._SESSION_LIMIT)
