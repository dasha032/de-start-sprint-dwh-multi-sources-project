...
class UsersOriginRepository:
    ...
    def list_users(self, user_threshold: int) -> List[RawUserObj]:
        with self._db.client().cursor(row_factory=class_row(RawUserObj)) as cur:
            cur.execute(
                """
...
class UserLoader:
    ...
    def parse_user_data(self, object_value: str):
    ...
    def load_users(self):
        ...
        with self.pg_dest.connection() as conn:
            ...
            for raw_user in load_queue:
                self.log.info(raw_user.object_value)
                user = self.parse_user_data(raw_user.object_value)
